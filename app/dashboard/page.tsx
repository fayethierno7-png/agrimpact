      ...
      <main className="flex-1 w-full max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6 sm:py-8 lg:py-10 pb-28 sm:pb-32 space-y-10 sm:space-y-12">
        ...
        <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 pb-6 border-b border-stone-200/80 dark:border-stone-800/80">
          <div>
            ...
            <div className="flex items-center gap-2 text-xs sm:text-sm text-stone-500 dark:text-stone-400 mt-1.5">
          ...
          <div className="flex flex-wrap items-center gap-3">
            ...
            <button
              ...
              className="px-4 py-2 rounded-full bg-white dark:bg-stone-800 border border-stone-200 dark:border-stone-700 hover:border-emerald-600 text-stone-700 dark:text-stone-200 hover:text-emerald-800 dark:hover:text-emerald-300 text-xs font-bold shadow-2xs flex items-center gap-2 transition-all hover:scale-105 cursor-pointer group whitespace-nowrap"
              title="Ouvrir le Calendrier Cultural & Saisons Agricoles"
            >
              <Calendar className="w-4 h-4 text-emerald-700 dark:text-emerald-400 group-hover:rotate-12 transition-transform shrink-0" />
