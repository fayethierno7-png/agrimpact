...
function PaymentPageContent() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (data.paymentUrl) {
        // Redirection vers le portail officiel Wave ou Orange Money
          ...
          <form onSubmit={handleSubmit} className="p-6 sm:p-7 space-y-6">
            ...
            <div>
              ...
              <p className="text-[11px] text-stone-500 mt-1.5">
                Vous recevrez une notification d&apos;autorisation de débit sur votre application{' '}
            ...
            >
              {isSubmitting ? (
                <div className="flex items-center gap-2">
                  ...
                  <span>Connexion à {provider === 'wave' ? 'Wave' : 'Orange Money'}...</span>
                </div>
              ) : (
                <>
                  <span>
