  ...
  return (
    <div className="flex-1 flex flex-col bg-[#FAF9F5] text-stone-900 w-full transition-colors duration-200">
      ...
      <main className="flex-1 w-full">
        ...
        {/* 13. SECTION GRILLE TARIFAIRE TRANSPARENTE */}
        <section className="py-20 px-4 sm:px-6 max-w-7xl mx-auto w-full" id="tarifs">
          <div className="text-center max-w-2xl mx-auto mb-12">
            <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-[#123C2B]/10 text-[#1A543D] text-xs font-black uppercase tracking-wider mb-3">
              Tarification Locale & Équitable
            </div>
            <h2 className="text-3xl sm:text-4xl font-black text-stone-900 tracking-tight">
              Un abonnement pensé pour le pouvoir d&apos;achat agricole
            </h2>
            <p className="text-stone-600 text-sm sm:text-base mt-3">
              Réglez en direct avec votre compte Wave ou Orange Money. Sans carte bancaire étrangère.
            </p>

            {/* Toggle Mensuel / Annuel */}
            <div className="inline-flex items-center gap-3 mt-6 bg-white px-4 py-2 rounded-full border border-stone-200">
              <span className={`text-xs font-bold ${!isAnnual ? 'text-[#0C2B1E]' : 'text-stone-500'}`}>Mensuel</span>
              <button
                type="button"
                onClick={() => setIsAnnual(!isAnnual)}
                className="w-11 h-6 bg-[#0C2B1E] rounded-full relative transition-colors cursor-pointer p-0.5"
              >
                <div
                  className={`w-5 h-5 rounded-full bg-[#C8EF56] transition-transform ${
                    isAnnual ? 'translate-x-5' : 'translate-x-0'
                  }`}
                />
              </button>
              <span className={`text-xs font-bold ${isAnnual ? 'text-[#0C2B1E]' : 'text-stone-500'}`}>
                Annuel <span className="text-[#0C2B1E] bg-[#C8EF56] px-2 py-0.5 rounded-full text-[10px] font-black">-20%</span>
              </span>
            </div>
          </div>

          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 items-stretch">
            {/* Formule 1 : Pilote Gratuit */}
            <div className="bg-white p-8 rounded-3xl border border-stone-200 shadow-xs flex flex-col justify-between">
              <div>
                <h3 className="text-xl font-black text-stone-900">Gratuit Pilote</h3>
                <p className="text-xs text-stone-500 mt-1">Pour tester sur votre première parcelle.</p>
                <div className="my-6">
                  <span className="text-4xl font-black text-stone-900">0</span>
                  <span className="text-xs font-bold text-stone-500 ml-2">FCFA / mois</span>
                </div>
                <ul className="space-y-3 text-xs text-stone-700">
                  <li className="flex items-center gap-2">
                    <Check className="w-4 h-4 text-emerald-600" />
                    <span>1 exploitation & 1 parcelle configurée</span>
                  </li>
                  <li className="flex items-center gap-2">
                    <Check className="w-4 h-4 text-emerald-600" />
                    <span>Météo locale en direct</span>
                  </li>
                  <li className="flex items-center gap-2">
                    <Check className="w-4 h-4 text-emerald-600" />
                    <span>Conseil agronomique du jour</span>
                  </li>
                  <li className="flex items-center gap-2 opacity-40">
                    <X className="w-4 h-4 text-stone-400" />
                    <span>Projection épidémique 14 jours</span>
                  </li>
                </ul>
              </div>
              <div className="mt-8">
                <Link
                  href="/signup"
                  className="w-full py-3 bg-stone-100 hover:bg-stone-200 text-stone-800 text-xs font-bold rounded-full flex items-center justify-center transition-all"
                >
            ...
            {/* Formule 2 : Pro Producteur (Mis en avant) */}
            <div className="bg-[#0C2B1E] text-white p-8 rounded-3xl border-2 border-[#1E6B47] shadow-2xl flex flex-col justify-between relative transform md:-translate-y-2">
              <div className="absolute -top-3.5 left-1/2 -translate-x-1/2 bg-[#C8EF56] text-[#0C2B1E] text-[10px] font-black uppercase tracking-wider px-3.5 py-1 rounded-full shadow-md">
                Recommandé Producteurs
              </div>
              <div>
                <h3 className="text-xl font-black text-white">Pro Producteur</h3>
                <p className="text-xs text-stone-300 mt-1">Le copilote complet pour rentabiliser vos parcelles.</p>
                <div className="my-6">
                  <span className="text-4xl font-black text-[#C8EF56]">{isAnnual ? '4 700' : '5 900'}</span>
                  <span className="text-xs font-bold text-stone-300 ml-2">FCFA / mois</span>
                </div>
                <ul className="space-y-3 text-xs text-stone-200">
                  <li className="flex items-center gap-2">
                    <Check className="w-4 h-4 text-[#C8EF56]" />
                    <span>Jusqu&apos;à 10 parcelles individuelles</span>
                  </li>
                  <li className="flex items-center gap-2">
                    <Check className="w-4 h-4 text-[#C8EF56]" />
                    <span>Projection mildiou & risques à 14 jours</span>
                  </li>
                  <li className="flex items-center gap-2">
                    <Check className="w-4 h-4 text-[#C8EF56]" />
                    <span>28 fenêtres de pulvérisation optimales</span>
                  </li>
                  <li className="flex items-center gap-2">
                    <Check className="w-4 h-4 text-[#C8EF56]" />
                    <span>Chiffrage du gain évitable en FCFA</span>
                  </li>
                  <li className="flex items-center gap-2">
                    <Check className="w-4 h-4 text-[#C8EF56]" />
                    <span>Alertes d&apos;urgence par SMS au champ</span>
                  </li>
                </ul>
              </div>
              <div className="mt-8">
                <Link
                  href="/signup"
                  className="w-full py-3 bg-[#C8EF56] hover:bg-[#B8DF44] text-[#0C2B1E] text-xs font-black rounded-full flex items-center justify-center transition-all shadow-md"
                >
                  Sélectionner Pro Producteur
                </Link>
                <div className="flex items-center justify-center gap-2 text-[10px] text-stone-400 mt-2">
                  ...
                  <span>•</span>
                  <strong className="text-white">Orange Money</strong>
                </div>
              </div>
            </div>

            {/* Formule 3 : Coopérative & GIE */}
            <div className="bg-white p-8 rounded-3xl border border-stone-200 shadow-xs flex flex-col justify-between">
              <div>
                <h3 className="text-xl font-black text-stone-900">Coopérative & GIE</h3>
                <p className="text-xs text-stone-500 mt-1">Pour groupements et périmètres irrigués.</p>
                <div className="my-6">
                  <span className="text-4xl font-black text-stone-900">{isAnnual ? '43 900' : '54 900'}</span>
                  <span className="text-xs font-bold text-stone-500 ml-2">FCFA / mois</span>
                </div>
                <ul className="space-y-3 text-xs text-stone-700">
                  <li className="flex items-center gap-2">
                    <Check className="w-4 h-4 text-emerald-600" />
                    <span>Multi-exploitations & parcelles illimitées</span>
                  </li>
                  <li className="flex items-center gap-2">
                    <Check className="w-4 h-4 text-emerald-600" />
                    <span>Accès multi-utilisateurs (président, agronomes)</span>
                  </li>
                  <li className="flex items-center gap-2">
                    <Check className="w-4 h-4 text-emerald-600" />
                    <span>Bilan agrométéo consolidé du groupement</span>
                  </li>
                  <li className="flex items-center gap-2">
                    <Check className="w-4 h-4 text-emerald-600" />
                    <span>Support agronomique prioritaire</span>
                  </li>
                </ul>
              </div>
              <div className="mt-8">
